...
| M18 Client Management | `m018-client-management.md`, `client-case-management.md`, proposed ADR 022 | Dedicated Product/Architecture candidate: canonical Person/contact-method/Household and formal Client lifecycle, assignments, scoped representatives, restrictions, onboarding/offboarding and client operational notes; closed source-aware client 360 composes owner projections while M019/M021/M022/M023 and all other owner facts remain canonical. |
