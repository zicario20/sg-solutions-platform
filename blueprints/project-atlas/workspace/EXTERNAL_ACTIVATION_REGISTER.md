...
| ID | Prerrequisito | Estado | Bloquea | Evidencia para cerrar |
|---|---|---|---|---|
| WA-001 | Proveedor de canal | `Architecture resolved — activation deferred` | Activación productiva de Meta Cloud API directa | Decision 028 selecciona Meta Cloud API directa; faltan cuenta/contrato, términos/datos, credenciales y pruebas controladas |
