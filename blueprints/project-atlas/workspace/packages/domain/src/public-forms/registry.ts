...
const basicIdentity: readonly FieldSeed[] = [
  { fieldCode: "first_name", fieldType: "text", step: 1, required: true, sensitivity: "basic_personal", maxLength: 80 },
  { fieldCode: "last_name", fieldType: "text", step: 1, required: true, sensitivity: "basic_personal", maxLength: 80 },
  { fieldCode: "email", fieldType: "email", step: 1, required: true, sensitivity: "basic_personal" },
  { fieldCode: "phone", fieldType: "tel", step: 1, required: true, sensitivity: "basic_personal" },
  { fieldCode: "preferred_language", fieldType: "select", step: 1, required: true, optionCodes: ["spanish", "english"] },
...
const seeds: readonly FormSeed[] = [
  {
    ...
    consentRequirements: [privacyConsent, serviceConsent, smsConsent, whatsappConsent, emailMarketingConsent],
    fields: [
      ...basicIdentity,
      { fieldCode: "reason", fieldType: "select", step: 2, required: true, optionCodes: ["general_question", "service_question", "callback_request"] },
      { fieldCode: "message", fieldType: "textarea", step: 2, required: true, maxLength: 1_000 },
      { fieldCode: "contact_preference", fieldType: "select", step: 2, required: true, optionCodes: ["email", "phone", "sms", "whatsapp"] },
    ],
  },
  {
    ...
    fields: [
      ...basicIdentity,
      { fieldCode: "service", fieldType: "select", step: 2, required: true, optionCodes: ["credit", "taxes", "business_formation", "business_funding", "home_buying", "marketplace"] },
      { fieldCode: "objective", fieldType: "textarea", step: 2, required: true, maxLength: 600 },
      { fieldCode: "general_situation", fieldType: "textarea", step: 2, required: false, maxLength: 800 },
      { fieldCode: "availability", fieldType: "select", step: 3, required: true, optionCodes: ["weekday_morning", "weekday_afternoon", "weekday_evening"] },
      { fieldCode: "preferred_channel", fieldType: "select", step: 3, required: true, optionCodes: ["email", "phone", "sms", "whatsapp"] },
    ],
  },
  {
    formCode: "callback",
    ...
    fields: [
      ...
      { fieldCode: "preferred_language", fieldType: "select", step: 1, required: true, optionCodes: ["spanish", "english"] },
      { fieldCode: "service", fieldType: "select", step: 2, required: true, optionCodes: ["credit", "taxes", "business_formation", "business_funding", "home_buying", "marketplace"] },
      { fieldCode: "preferred_time", fieldType: "select", step: 2, required: true, optionCodes: ["weekday_morning", "weekday_afternoon", "weekday_evening"] },
  ...
  },
  {
    ...
    fields: [
      ...basicIdentity,
      { fieldCode: "objective", fieldType: "textarea", step: 2, required: true, maxLength: 600 },
      { fieldCode: "approximate_credit_band", fieldType: "select", step: 2, sensitivity: "financial", optionCodes: ["band_below_580", "band_580_619", "band_620_679", "band_680_plus", "band_unknown"] },
      { fieldCode: "future_home_purchase", fieldType: "boolean", step: 2 },
      { fieldCode: "report_available", fieldType: "boolean", step: 2 },
      { fieldCode: "general_problem_type", fieldType: "select", step: 2, required: true, optionCodes: ["late_payments", "collections", "inaccuracies", "other"] },
  ...
  },
  {
    ...
    fields: [
      ...basicIdentity,
      { fieldCode: "tax_year", fieldType: "number", step: 2, required: true, minimum: 2000, maximum: 2100 },
      ...
      { fieldCode: "business_activity", fieldType: "text", step: 2, maxLength: 160, visibleWhen: { operator: "equals", fieldCode: "self_employed", value: true } },
  ...
  },
  {
    ...
    fields: [
      ...
      { fieldCode: "structure_general", fieldType: "select", step: 2, required: true, optionCodes: ["single_member", "multi_member", "undecided"] },
      { fieldCode: "owner_count", fieldType: "number", step: 2, required: true, minimum: 2, maximum: 20, visibleWhen: { operator: "equals", fieldCode: "structure_general", value: "multi_member" } },
  ...
  },
  {
    ...
    fields: [
      ...basicIdentity,
      { fieldCode: "business_type", fieldType: "select", step: 2, required: true, optionCodes: ["sole_proprietor", "llc", "corporation", "partnership", "other"] },
      { fieldCode: "business_age_band", fieldType: "select", step: 2, required: true, optionCodes: ["pre_revenue", "under_one_year", "one_to_two_years", "over_two_years"] },
      { fieldCode: "monthly_revenue_band", fieldType: "select", step: 2, sensitivity: "financial", optionCodes: ["revenue_under_5k", "revenue_5k_20k", "revenue_20k_50k", "revenue_over_50k"] },
      { fieldCode: "funding_amount_band", fieldType: "select", step: 2, sensitivity: "financial", optionCodes: ["funding_under_25k", "funding_25k_100k", "funding_over_100k"] },
  ...
  },
  {
    ...
    fields: [
      ...
      { fieldCode: "household_size", fieldType: "number", step: 2, required: true, minimum: 1, maximum: 30 },
      { fieldCode: "annual_income_band", fieldType: "select", step: 2, sensitivity: "financial", optionCodes: ["income_under_40k", "income_40k_80k", "income_80k_150k", "income_over_150k"] },
      { fieldCode: "approximate_credit_band", fieldType: "select", step: 2, sensitivity: "financial", optionCodes: ["band_below_580", "band_580_619", "band_620_679", "band_680_plus", "band_unknown"] },
      { fieldCode: "first_home", fieldType: "boolean", step: 2 },
      { fieldCode: "purchase_timeline", fieldType: "select", step: 2, required: true, optionCodes: ["within_six_months", "six_to_twelve_months", "over_twelve_months"] },
      { fieldCode: "property_type", fieldType: "select", step: 2, required: true, optionCodes: ["single_family", "condo", "manufactured", "undecided"] },
      { fieldCode: "program_interest", fieldType: "select", step: 2, optionCodes: ["usda", "fha", "other", "undecided"] },
      appointmentPreference,
    ],
  },
  {
    ...
    consentRequirements: [privacyConsent, serviceConsent, partnerConsent, referralConsent, emailMarketingConsent],
    fields: [
      ...basicIdentity,
      { fieldCode: "product_category", fieldType: "select", step: 2, required: true, optionCodes: ["credit_monitoring", "business_services", "financial_products", "other"] },
      { fieldCode: "approximate_credit_band", fieldType: "select", step: 2, sensitivity: "financial", optionCodes: ["band_below_580", "band_580_619", "band_620_679", "band_680_plus", "band_unknown"] },
      { fieldCode: "objective", fieldType: "textarea", step: 2, required: true, maxLength: 600 },
    ],
  },
...
function hash(value: unknown): string {
  ...
  for (let index = 0; index < serialized.length; index += 1) {
    ...
    for (let lane = 0; lane < accumulators.length; lane += 1) {
      ...
      accumulators[lane] = Math.imul(
        (accumulators[lane] ?? 0) ^ mixedCode,
        0x01000193 + lane * 2,
      );
    }
  }
...
function buildVersion(seed: FormSeed, locale: PublicFormLocale): FormDefinitionVersion {
  ...
  return Object.freeze({
    ...
    consentRequirements: Object.freeze(seed.consentRequirements.map((consent) => Object.freeze({ ...consent }))),
