...
export const future_moduleRecords = pgTable("future_module_records", {
...
}, (table) => [uniqueIndex("future_module_records_code_unique").on(table.code), index("future_module_records_status_idx").on(table.status)]);

export const future_moduleEvidenceLinks = pgTable("future_module_evidence_links", {
...
}, (table) => [uniqueIndex("future_module_evidence_links_code_unique").on(table.code), index("future_module_evidence_links_record_idx").on(table.recordCode)]);

export const future_moduleReviewRequests = pgTable("future_module_review_requests", {
...
}, (table) => [uniqueIndex("future_module_review_requests_code_unique").on(table.code), index("future_module_review_requests_record_idx").on(table.recordCode)]);

export const future_moduleActionRequests = pgTable("future_module_action_requests", {
...
}, (table) => [uniqueIndex("future_module_action_requests_code_unique").on(table.code), index("future_module_action_requests_record_idx").on(table.recordCode)]);
