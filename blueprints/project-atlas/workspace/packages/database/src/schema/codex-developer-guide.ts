...
export const developer_guideRecords = pgTable("developer_guide_records", {
...
}, (table) => [uniqueIndex("developer_guide_records_code_unique").on(table.code), index("developer_guide_records_status_idx").on(table.status)]);

export const developer_guideEvidenceLinks = pgTable("developer_guide_evidence_links", {
...
}, (table) => [uniqueIndex("developer_guide_evidence_links_code_unique").on(table.code), index("developer_guide_evidence_links_record_idx").on(table.recordCode)]);

export const developer_guideReviewRequests = pgTable("developer_guide_review_requests", {
...
}, (table) => [uniqueIndex("developer_guide_review_requests_code_unique").on(table.code), index("developer_guide_review_requests_record_idx").on(table.recordCode)]);

export const developer_guideActionRequests = pgTable("developer_guide_action_requests", {
...
}, (table) => [uniqueIndex("developer_guide_action_requests_code_unique").on(table.code), index("developer_guide_action_requests_record_idx").on(table.recordCode)]);
