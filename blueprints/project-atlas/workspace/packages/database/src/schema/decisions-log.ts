...
}, (table) => [uniqueIndex("decision_records_code_unique").on(table.code), index("decision_records_status_idx").on(table.status)]);

export const decisionEvidenceLinks = pgTable("decision_evidence_links", {
...
}, (table) => [uniqueIndex("decision_evidence_links_code_unique").on(table.code), index("decision_evidence_links_record_idx").on(table.recordCode)]);

export const decisionReviewRequests = pgTable("decision_review_requests", {
...
}, (table) => [uniqueIndex("decision_review_requests_code_unique").on(table.code), index("decision_review_requests_record_idx").on(table.recordCode)]);

export const decisionActionRequests = pgTable("decision_action_requests", {
...
}, (table) => [uniqueIndex("decision_action_requests_code_unique").on(table.code), index("decision_action_requests_record_idx").on(table.recordCode)]);
