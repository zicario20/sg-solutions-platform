...
}, (table) => [uniqueIndex("experiment_records_code_unique").on(table.code), index("experiment_records_status_idx").on(table.status)]);

export const experimentEvidenceLinks = pgTable("experiment_evidence_links", {
...
}, (table) => [uniqueIndex("experiment_evidence_links_code_unique").on(table.code), index("experiment_evidence_links_record_idx").on(table.recordCode)]);

export const experimentReviewRequests = pgTable("experiment_review_requests", {
...
}, (table) => [uniqueIndex("experiment_review_requests_code_unique").on(table.code), index("experiment_review_requests_record_idx").on(table.recordCode)]);

export const experimentActionRequests = pgTable("experiment_action_requests", {
...
}, (table) => [uniqueIndex("experiment_action_requests_code_unique").on(table.code), index("experiment_action_requests_record_idx").on(table.recordCode)]);
